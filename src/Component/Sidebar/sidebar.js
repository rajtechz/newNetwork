...
const Sidebar = ({ open, toggleSidebar }) => {
  ...
  return (
    ...
    >
      ...
      <List>
        {/* Show Review Batch only for NetworkSubAdmin */}
        {(user?.role === 'NetworkAdmin' || user?.role === 'NetworkSubAdmin') && (
          <ListItem
            component={NavLink}
            to="/"
        ...
        {/* Show other routes only for NetworkAdmin */}
        {user?.role === "NetworkAdmin"&& (
          <>
            ...
            >
              ...
              <ListItemText primary="Parial Approval" />
            </ListItem>
